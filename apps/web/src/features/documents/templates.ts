...
export function agreementDocument(row: RecordValue) {
 ...
 <section class="page"><img class="stamp" src="${esc(stamp)}" alt="Agreement stamp paper"><div class="annexure">Annexure 2</div><h1 class="title">Agreement between Consumer &amp; Vendor for installation of grid connected rooftop solar (RTS) project<br>under PM – Surya Ghar: Muft Bijali Yojana</h1>
 ...
 <p class="center"><b>Between</b></p><p><b>${esc(customer.name)} (Name of Consumer)</b> having<br><b>${address}</b> (herein referred to as first Party i.e. Consumer / purchaser / owner of system).</p><p class="center"><b>And</b></p><p><b>A1 SOLAR SOLUTIONS (Name of Vendor)</b> having registered office at <b>VISHNUPUR KAIJU PATEHPUR VAISHALI BIHAR</b><br>(hereinafter referred to as second Party i.e. Vendor / contractor / System Integrator).</p>
 ...
 <div class="party-grid"><div class="signature-box"><b>First Party (Consumer)</b><p>Name: ${esc(customer.name)}<br>Address: ${address}</p><div style="height:25mm"></div><div class="line">Signature:<br>Date: ${esc(displayDate)}</div></div><div class="signature-box"><b>Second Party (Vendor)</b><p>Name: A1 SOLAR SOLUTIONS<br>Address: VISHNUPUR KAIJU PATEHPUR<br>VAISHALI BIHAR</p><img class="vendor-sign" src="${esc(vendorSign)}" alt="Authorized vendor signature"><div class="line">Signature:<br>Date: ${esc(displayDate)}</div></div></div>
